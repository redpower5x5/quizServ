                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          onChanged: (text) => loginPageBloc.editName.add(text),
                        ),
                              ...
                              child: snapshot.data != null? Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(snapshot.data??'', style: Theme.of(context).textTheme.subtitle1, textAlign: TextAlign.center,),
                                  ),
                                  const SizedBox(height: 15,)
                                ],
                              ) : const SizedBox()
                        ...
                        StreamBuilder<ButtonState>(
                          ...
                          builder: (_, s) =>  LoginPageButton(
                            ...
                            onTap: () => loginPageBloc.pushTap.add(s.requireData.isActive),
