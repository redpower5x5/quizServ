...
class LoginPageButton extends StatefulWidget {
  ...
  const LoginPageButton({Key? key, required this.onTap, this.height = 70, required this.text, this.isActive = true}) : super(key: key);
      ...
      child: Stack(
        children: [
          GestureDetector(
              ...
              onLongPressEnd: widget.isActive? (_) => unpressedAnimation() : (_) {},
              child: Align(
                alignment: Alignment.bottomCenter,
                child: Consumer<ThemeManager>(
                  builder: (_, themeManager, __) =>
                      AnimatedContainer(
                        height: widget.isActive? widget.height - _h : widget.height - _maxHeight,
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color:  widget.isActive? themeManager.currentTheme.green : themeManager.currentTheme.grey,
                                    borderRadius: BorderRadius.circular(16)
                                ),
                                child: Center(
                                  child: Text(
